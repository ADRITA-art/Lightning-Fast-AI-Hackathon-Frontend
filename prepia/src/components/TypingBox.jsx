    ...
    <div className="z-10 max-w-[600px] flex space-y-6 flex-col bg-gradient-to-tr from-slate-300/30 via-gray-400/30 to-slate-600-400/30 p-4 backdrop-blur-md rounded-xl border-slate-100/30 border">
      <div>
        <h2 className="text-black font-bold text-xl">
          Hello! Ask me anything about Engineering topics such as Mechanical, Electrical, Civil, Computer Science, and more.
        </h2>
        <p className="text-black/65">
          Type any engineering-related question you have.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="gap-3 flex">
          <input
            ...
            placeholder="Enter your engineering question"
            value={question}
